...
function initSlideShow(){
    ...
    $('div.gallery-items').fadeGallery({
        slides:'div.gallery-items-list>div',
        pagerLinks:'div.gallery-items-prev div',
    ...
    $('div.gallery2-frame').fadeGallery({
        slides:'ul.gallery>li',
        pagerLinks:'ul.preview-list li',
        switchSimultaneously:true,
        disableWhileAnimating:false,
        autoRotation:false,
        autoHeight:true,
